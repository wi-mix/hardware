...
module soc_system_mm_interconnect_0 (
	...
	wire  [111:0] sysid_qsys_0_control_slave_agent_rp_data;                       // sysid_qsys_0_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire          red_leds_s1_agent_rp_valid;                                     // red_leds_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] red_leds_s1_agent_rp_data;                                      // red_leds_s1_agent:rp_data -> router_003:sink_data
	wire          red_leds_s1_agent_rp_ready;                                     // router_003:sink_ready -> red_leds_s1_agent:rp_ready
	wire          red_leds_s1_agent_rp_startofpacket;                             // red_leds_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          red_leds_s1_agent_rp_endofpacket;                               // red_leds_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [111:0] hps_h2f_lw_axi_master_wr_limiter_cmd_src_data;                  // hps_h2f_lw_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          hps_h2f_lw_axi_master_wr_limiter_cmd_src_ready;                 // cmd_demux:sink_ready -> hps_h2f_lw_axi_master_wr_limiter:cmd_src_ready
	wire    [1:0] hps_h2f_lw_axi_master_wr_limiter_cmd_src_channel;               // hps_h2f_lw_axi_master_wr_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [111:0] rsp_mux_src_data;                                               // rsp_mux:src_data -> hps_h2f_lw_axi_master_wr_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                              // hps_h2f_lw_axi_master_wr_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                            // rsp_mux:src_channel -> hps_h2f_lw_axi_master_wr_limiter:rsp_sink_channel
	...
	wire  [111:0] hps_h2f_lw_axi_master_rd_limiter_cmd_src_data;                  // hps_h2f_lw_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [1:0] hps_h2f_lw_axi_master_rd_limiter_cmd_src_channel;               // hps_h2f_lw_axi_master_rd_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [111:0] rsp_mux_001_src_data;                                           // rsp_mux_001:src_data -> hps_h2f_lw_axi_master_rd_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                          // hps_h2f_lw_axi_master_rd_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                        // rsp_mux_001:src_channel -> hps_h2f_lw_axi_master_rd_limiter:rsp_sink_channel
	...
	wire  [111:0] cmd_mux_src_data;                                               // cmd_mux:src_data -> sysid_qsys_0_control_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                              // sysid_qsys_0_control_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                            // cmd_mux:src_channel -> sysid_qsys_0_control_slave_burst_adapter:sink0_channel
	...
	wire  [111:0] sysid_qsys_0_control_slave_burst_adapter_source0_data;          // sysid_qsys_0_control_slave_burst_adapter:source0_data -> sysid_qsys_0_control_slave_agent:cp_data
	...
	wire          cmd_mux_001_src_valid;                                          // cmd_mux_001:src_valid -> red_leds_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                           // cmd_mux_001:src_data -> red_leds_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                          // red_leds_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                        // cmd_mux_001:src_channel -> red_leds_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                  // cmd_mux_001:src_startofpacket -> red_leds_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                    // cmd_mux_001:src_endofpacket -> red_leds_s1_burst_adapter:sink0_endofpacket
	wire          red_leds_s1_burst_adapter_source0_valid;                        // red_leds_s1_burst_adapter:source0_valid -> red_leds_s1_agent:cp_valid
	wire  [111:0] red_leds_s1_burst_adapter_source0_data;                         // red_leds_s1_burst_adapter:source0_data -> red_leds_s1_agent:cp_data
	wire          red_leds_s1_burst_adapter_source0_ready;                        // red_leds_s1_agent:cp_ready -> red_leds_s1_burst_adapter:source0_ready
	wire    [1:0] red_leds_s1_burst_adapter_source0_channel;                      // red_leds_s1_burst_adapter:source0_channel -> red_leds_s1_agent:cp_channel
	...
	wire    [1:0] hps_h2f_lw_axi_master_wr_limiter_cmd_valid_data;                // hps_h2f_lw_axi_master_wr_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [1:0] hps_h2f_lw_axi_master_rd_limiter_cmd_valid_data;                // hps_h2f_lw_axi_master_rd_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          red_leds_s1_agent_rdata_fifo_out_valid;                         // red_leds_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] red_leds_s1_agent_rdata_fifo_out_data;                          // red_leds_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          red_leds_s1_agent_rdata_fifo_out_ready;                         // avalon_st_adapter_001:in_0_ready -> red_leds_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                              // avalon_st_adapter_001:out_0_valid -> red_leds_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                               // avalon_st_adapter_001:out_0_data -> red_leds_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                              // red_leds_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                              // avalon_st_adapter_001:out_0_error -> red_leds_s1_agent:rdata_fifo_sink_error
