	soc_system u0 (
		.adc_controller_0_adc_control_read          (<connected-to-adc_controller_0_adc_control_read>),          //           adc_controller_0_adc_control.read
		.adc_controller_0_adc_control_readdata      (<connected-to-adc_controller_0_adc_control_readdata>),      //                                       .readdata
		.adc_controller_0_adc_control_write         (<connected-to-adc_controller_0_adc_control_write>),         //                                       .write
		.adc_controller_0_adc_control_writedata     (<connected-to-adc_controller_0_adc_control_writedata>),     //                                       .writedata
		.adc_controller_0_adc_data_read             (<connected-to-adc_controller_0_adc_data_read>),             //              adc_controller_0_adc_data.read
		.adc_controller_0_adc_data_readdata         (<connected-to-adc_controller_0_adc_data_readdata>),         //                                       .readdata
		.adc_controller_0_conduit_adc_export_clk    (<connected-to-adc_controller_0_conduit_adc_export_clk>),    //           adc_controller_0_conduit_adc.export_clk
		.adc_controller_0_conduit_adc_export_convst (<connected-to-adc_controller_0_conduit_adc_export_convst>), //                                       .export_convst
		.adc_controller_0_conduit_adc_export_sdo    (<connected-to-adc_controller_0_conduit_adc_export_sdo>),    //                                       .export_sdo
		.adc_controller_0_conduit_adc_export_sdi    (<connected-to-adc_controller_0_conduit_adc_export_sdi>),    //                                       .export_sdi
		.adc_controller_0_data_ready_irq            (<connected-to-adc_controller_0_data_ready_irq>),            //            adc_controller_0_data_ready.irq
		.adc_controller_0_invalid_configuration_irq (<connected-to-adc_controller_0_invalid_configuration_irq>), // adc_controller_0_invalid_configuration.irq
		.adc_controller_0_reset_reset               (<connected-to-adc_controller_0_reset_reset>),               //                 adc_controller_0_reset.reset
		...
		.adc_controller_conduit_adc_export_clk      (<connected-to-adc_controller_conduit_adc_export_clk>),      //             adc_controller_conduit_adc.export_clk
		.adc_controller_conduit_adc_export_convst   (<connected-to-adc_controller_conduit_adc_export_convst>),   //                                       .export_convst
		.adc_controller_conduit_adc_export_sdo      (<connected-to-adc_controller_conduit_adc_export_sdo>),      //                                       .export_sdo
		.adc_controller_conduit_adc_export_sdi      (<connected-to-adc_controller_conduit_adc_export_sdi>)       //                                       .export_sdi
	);
